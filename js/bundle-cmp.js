...
(function() {
    ...
    var P = {
        ...
        toonGoggles: !!window.isToonGoggles,
    ...
    Game.prototype = {
        ...
        newAttempt: function() {
            ...
            if (this.attempts == 2 && !P.toonGoggles) {
                addToHome.show()
            }
            ...
            if (window.gmapi && !P.inAppGames) {
                gmapi(function(api) { /*api.game.leaderboard.sendScore(score)*/ })
            }
            if (!P.inAppGames && !this.doubleClickRetry && this.attempts % this.adInterval == 0) {
...
//            }
        ...
        openSaga: function() {
            var url = "https://itunes.apple.com/app/id933294368?mt=8";
            if (P.inAppGames) {
                url += "?utm_source=ubersocialios&utm_medium=inapp"
            }
    ...
    EndScreen.prototype = extendPrototype(Screen, {
        ...
        create: function() {
            ...
            if (!P.cocoon && !P.toonGoggles && !P.inAppGames) {
//                buttons.push(new Button({
//                    id: "menu",
